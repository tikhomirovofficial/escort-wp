...
function blankslate_enqueue()
{
    ...
    wp_enqueue_style('freedom', get_template_directory_uri().'/assets/lib/freedom.css');
    wp_enqueue_script('notification', get_template_directory_uri().'/assets/js/notification.js');
